...
const sections = computed(() => [
  ...
  {
    titleKey: 'media',
    title: t('shortcuts.mediaPlayer'),
    icon: 'mdi-play-circle-outline',
    shortcuts: [
      { keys: 'Space', desc: t('shortcuts.playPause') },
      { keys: 'S', desc: t('shortcuts.stop') },
      { keys: 'L', desc: t('shortcuts.toggleLoop') },
      { keys: 'G', desc: t('shortcuts.toggleSpectrogram') },
      { keys: 'M', desc: t('shortcuts.addAnnotation') },
      { keys: 'ArrowLeft', desc: t('shortcuts.rewind5') },
      { keys: 'ArrowRight', desc: t('shortcuts.forward5') },
      { keys: 'Shift + ArrowLeft', desc: t('shortcuts.rewind15') },
      { keys: 'Shift + ArrowRight', desc: t('shortcuts.forward15') },
      { keys: 'ArrowUp', desc: t('shortcuts.volumeUp') },
      { keys: 'ArrowDown', desc: t('shortcuts.volumeDown') },
      { keys: '1 .. 6', desc: t('shortcuts.speedPresets') },
    ],
  },
  {
    titleKey: 'general',
